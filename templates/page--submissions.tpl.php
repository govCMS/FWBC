<?php
/*
 * Interventions and submissions list template
*/
$sw = trim($_GET['sw']);
$status = $_GET['status'];
$state = $_GET['state'];
		...
		<div id="leftContent" class="legal-cases-list">
			<div class="contentBox wide">
				<div class="content-block">
					...
					<?php echo views_embed_view('submissions'); ?>
					<h2>Need more information about interventions and submissions?</h2><p>For further information or assistance contact the FWBC Hotline on <strong>1800 003 338.</strong></p>
				</div>
