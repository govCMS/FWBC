...
?>
	...
	<div id="slideshow" class="box">
		...
		<div id="slides">
			...
			<div class="home-slide-item" id="slide1" style="display: block; background-image: url(/app/img/slides/fwbc-onsite-slider.jpg);">
															<h2><a class="" style="color:#1f3336;" onclick="ga('send','event','app','homepage','FWBC OnSite');" href="/app" title="FWBC OnSite App">FWBC On Site</a>
						</h2>
						<h4 style="padding-top:57px;"><a class="" style="color:#1f3336;" onclick="ga('send','event','app','homepage','FWBC OnSite');" href="/app" title="FWBC OnSite App">Our new App provides<br /> information and advice<br /> about your workplace rights<br /> and responsibilities on site &gt;</a></h4>

			</div>
					</div>
		<div id="pager">
			<ul>
								<li style="width:;" class="last"><a href="#" rel="slide1" class="selected">Industrial Action Flyer</a></li>
							</ul>
		</div>
	</div> -->
