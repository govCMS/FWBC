...
<div class="box" id="subNav">
  ...
  <ul <?php if (empty($grampa)) {
    echo ' class="top-level-selected"';
  } ?>>
    <?php
    // first level
    foreach ($child_pages as $first_nid => $first_data) {
      ...
      <li<?php echo $s; ?>><a
          href="<?php echo fwbc_page_url('node/' . $first_nid); ?>"><span></span><?php echo $first_data['title']; ?>
        </a>
        <?php if (count($first_data['childs'])) { ?>
          <ul class="secondLevel">
            ...
            foreach ($first_data['childs'] as $second_nid => $second_data) {
              ...
              ?>
              <li<?php echo $s; ?>><a
                  href="<?php echo fwbc_page_url('node/' . $second_nid); ?>"><span></span><?php echo $second_data['title']; ?>
                </a>
                <?php if (count($second_data['childs'])) { ?>
                  <ul class="thirdLevel">
                    ...
                    foreach ($second_data['childs'] as $third_nid => $third_data) {
                      ...
                      ?>
                      <li<?php echo $s; ?>><a
                          href="<?php echo fwbc_page_url('node/' . $third_nid); ?>"><span></span><?php echo $third_data['title']; ?>
                        </a>
                        <?php if (count($third_data['childs'])): ?>
                          <ul class="fourthLevel">
                            ...
                            foreach ($third_data['childs'] as $forth_nid => $forth_data) {
                              $s = '';
                              if ($curr_nid == $forth_nid) {
                                $s = ' class="selected"';
                              }
                              ?>
                              <li<?php echo $s; ?>><a
                                  href="<?php echo fwbc_page_url('node/' . $forth_nid); ?>"><span></span><?php echo $forth_data['title']; ?>
                                </a></li>
